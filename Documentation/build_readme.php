...
exec('diff -u ./02_FacetedSearchTemplate.fusion ./02a_FacetedHighlightedSearchTemplate.fusion | tail -n +3 > ./02a_FacetedHighlightedSearchTemplate.fusion.diff');
...
$readme = str_replace('###02a_FacetedHighlightedSearchTemplate.fusion###', file_get_contents(__DIR__ . '/02a_FacetedHighlightedSearchTemplate.fusion'), $readme);
$readme = str_replace('###02a_FacetedHighlightedSearchTemplate.fusion.diff###', file_get_contents(__DIR__ . '/02a_FacetedHighlightedSearchTemplate.fusion.diff'), $readme);
