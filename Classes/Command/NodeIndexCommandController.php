...
class NodeIndexCommandController extends CommandController
{
    ...
    /**
     * @Flow\Inject
     * @var \Sandstorm\LightweightElasticsearch\Elasticsearch\ElasticsearchClient
     */
     ...
     * @throws ApiException
     */
    public function buildCommand(int $limit = null, bool $update = false, string $workspace = 'live', string $postfix = null): void
    {
        $elasticsearch = $this->elasticsearchFactory->build(ContentRepositoryId::fromString('default'));
        $logger = new Logger([new ConsoleBackend()]);
     ...
     */
    private function createContentContext(string $workspaceName, array $dimensions = []): \Neos\Rector\ContentRepository90\Legacy\LegacyContextStub
    {
        $contextProperties = [
